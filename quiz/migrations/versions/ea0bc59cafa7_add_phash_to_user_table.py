"""add phash to user table

Revision ID: ea0bc59cafa7
Revises: 
Create Date: 2020-05-14 17:15:27.837098
...
def upgrade():
    ...
    sa.Column('pword_h', sa.String(length=128), nullable=True),
